        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left">
            ...
            delay: 0.1
              ...
              <AnimatePresence mode="wait">
                {showAlternateName ? <motion.span key="maureen" initial={{
                opacity: 0,
                y: 20
              }} animate={{
                opacity: 1,
                ...
                duration: 0.3
                    ...
                    Maureen
                  </motion.span> : <motion.span key="dzifa" initial={{
                opacity: 0,
                y: 20
              }} animate={{
                opacity: 1,
              ...
              <motion.span className="inline-block cursor-pointer select-none" whileHover={{
              scale: 1.1
            }} animate={isWaving ? {
            ...
            duration: 0.5,
            delay: 0.2
          }} className="text-lg font-medium text-foreground mb-6 font-serif md:text-lg">
            ...
            duration: 0.6,
            delay: 0.3
          }} className="text-base text-muted-foreground max-w-xl mx-auto lg:mx-0 mb-8 md:text-base font-serif">
          ...
          delay: 0.3
            ...
            <div className="relative w-full max-w-lg">
              <img src={dzidziIllustration} alt="Dzidzi working at laptop with cat" className="w-full h-auto object-contain" />
            </div>
          </motion.div>
        </div>
      </div>
